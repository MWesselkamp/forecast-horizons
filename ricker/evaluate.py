...
df_climatology = config['forcing']['resolution']/((1-decorrelation_coefficient)/(1+decorrelation_coefficient)) - 1
...
plot_horizon_maps(iterated_dynamics_species1[:,:50],
                  iterated_dynamics_species2[:,:50])
